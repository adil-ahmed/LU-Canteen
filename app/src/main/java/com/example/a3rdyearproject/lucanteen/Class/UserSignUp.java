package com.example.a3rdyearproject.lucanteen.Class;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                String emailText = email.getText().toString().trim();//ommit for space
                        ...
                        (UserSignUp.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task)
                            {
                                ...
                                if(task.isSuccessful())
                                {
                                    ...
                                    Intent intent = new Intent(UserSignUp.this,ShowItem.class);
