...
public class CustomListAdapter2 extends BaseAdapter
{
    ...
    public CustomListAdapter2(Activity activity,
    ...
    {
        if(view == null){
            view = activity.getLayoutInflater().inflate(R.layout.style_normal, viewGroup, false);// style layout contain the custom design
        }
